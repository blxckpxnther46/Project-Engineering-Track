                    ...
                    <div className="p-8 md:p-12">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                            ...
                            <div className="md:col-span-8 space-y-10">
                                ...
                                {/* FIXED: Only show buttons based on user permissions */}
                                <div className="pt-10 flex flex-col md:flex-row gap-4 items-center border-t border-slate-100">
                                    {/* FIXED: Only show RSVP button if user is invited and hasn't RSVPed yet */}
                                    ...
                                    {/* FIXED: Only show Delete button if user is the creator */}
                                    {event.isCreator && (
                                        <button 
